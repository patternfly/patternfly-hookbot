    ...
    return new Promise(resolve => {
        ...
        cloneRepo(cloneURL, dir)
            ...
            .then(() => {
                ...
                exec(`git config user.email ${process.env.GIT_EMAIL}`, {cwd: dir});
                exec(`git config user.name ${process.env.GIT_USERNAME}`, {cwd: dir});
            ...
            .then((result) => console.info('Created PR:', result['data']['html_url']))
            .then(() => resolve())
